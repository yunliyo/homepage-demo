! function (t) {
    ...
    var k = function (t) {
        ...
        return r(e, t), Object.defineProperty(e.prototype, "blocks", {
            ...
            set: function (t) {
                switch (t) {
                    case i.PLAYING:
                        break;
                    case i.LOSE:
                        this.setStatusText(f.default("猫猫已经跑出地图边缘，你输啦！"));
                        break;
                    case i.WIN:
                        this.setStatusText(f.default("猫猫已经无路可走，你赢了！"));
                        break;
                    default:
                        return
                }
            ...
            return n ? n.isWall ? (this.setStatusText(f.default("点击位置已经是墙了，禁止点击")), !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("点击位置是猫咪当前位置，禁止点击")), !1) : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("小猫已经无路可走，你赢了")), this.state = i.WIN, !1) : (this.setStatusText(f.default("您点击了 ") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.default("猫认输，你赢了！")), this.state = i.WIN), !0)) : (this.setStatusText(f.default("代码错误，当前位置不存在")), !1)
