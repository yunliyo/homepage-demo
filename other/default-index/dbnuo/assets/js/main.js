(function () {
    ...
    function () {
        function t() {
            ...
            d(a(".js-HasVH"), function (e) {
                e.style.height = t * parseFloat(e.getAttribute("data-vh")) + 65 + "px"
            }), y = t, m()
        }
    ...
    function () {
        var t = i(".Email");
        l("href", "mailto:yunliyo@foxmail.com", t), t.innerHTML = "<strong>yunliyo</strong>@<strong>foxmail</strong>.com"
    }();
    var H = !1;
